#ifndef INC_ST7789BITMAP_H_
#define INC_ST7789BITMAP_H_

#include "stdio.h"

//---------------------------------------------------------------------------//

#define FONT_DEFFAULT_COLUMN 												5
#define FONT_DEFFAULT_ROW													7

//---------------------------------------------------------------------------//

static const uint8_t asciiBitMap[] = {
